...
scope.TopNode = function(elements) {
    return this.init.apply(this, elements instanceof Array ? elements : [elements]);
};

scope.TopNode.prototype = {
...
scope.Type.prototype = {
    ...
    addEntries: function (entries) {
        if (this.json['$ref']) {
            this.json.items = entries instanceof Array ? entries[0] : entries;
        } else if (this.json.type === "array" && (!(entries instanceof Array) || entries.length > 0)) {
